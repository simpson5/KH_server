...
<%@page import="movie.model.vo.MovieNow"%>
...
<link rel="stylesheet" href="<%=request.getContextPath() %>/css/movie_movieView.css" />
        ...
        <div id="viewContent2">
	        <div id="viewLine">
	            <a href="<%=request.getContextPath() %>/movie/movieView/movieDescription.do?movieCode=<%=movie.getMovieCode() %>&memberId=<%=memberLoggedIn!=null?memberLoggedIn.getMemberId():""%>" style="color: white;">줄거리</a>
	        ...
	        <div id="box1" class="box">
	            <span class="view_title">줄거리</span>
