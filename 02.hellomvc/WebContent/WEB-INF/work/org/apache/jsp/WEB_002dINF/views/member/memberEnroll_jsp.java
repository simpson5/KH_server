 ...
 * Generated at: 2021-03-29 11:07:34 UTC
...
public final class memberEnroll_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/common/header.jsp", Long.valueOf(1617008049678L));
 ...
 if(loginMember == null) { 
      ...
      out.write("\t<form name=\"memberEnrollFrm\" action=\"\" method=\"post\" id=\"memberEnrollFrm\">\r\n");
      out.write("\t\t<table>\r\n");
      out.write("\t\t\t<tr>\r\n");
      ...
      out.write("\tvar id = $(\"#memberId_\").val();\r\n");
      out.write("\tvar password = $(\"#password_\").val();\r\n");
      out.write("\tvar password_check = $(\"#password2\").val();\r\n");
      out.write("\tvar phone = $(\"#phone\").val();\r\n");
      out.write("\t\r\n");
      out.write("\tif(/^.{4,}$/.test(id) == false) {\r\n");
      out.write("       alert(\"아이디가 유효하지 않습니다.\");\r\n");
      out.write("       return false;\r\n");
      out.write("    }\r\n");
      out.write("\t\r\n");
      out.write("\tif(/^.{4,}$/.test(password) == false) {\r\n");
      out.write("\t   alert(\"비밀번호가 유효하지 않습니다.\");\r\n");
      out.write("\t   return false;\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tif(password !=password_check) {\r\n");
      out.write("\t\talert(\"위와 다릅니다\");\r\n");
      out.write("\t\treturn false;\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
